...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="➗ Add LUNA To Your Group ➗", url="t.me/Missharelyluna_bot?startgroup=new"
        ),
    ],
]
...
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project by contacting [ALAN WALKER](https://t.me/alpha_ romeo_06) \
...
def emiko_about_callback(update, context):
    ...
    if query.data == "emiko_":
        ...
        query.message.edit_text(
            ...
            "\nJoin My Support Group/Channel for see or report a problem on THE LUNA.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
